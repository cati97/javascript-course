...
// document.querySelector(".poll").addEventListener("click", poll.registerNewAnswer); // this.options is not iterable - because this is bound to the button element
...
const displayResultsArray = poll.displayResults.bind({ answers: testData1 }, "array");
console.log(displayResultsArray());
